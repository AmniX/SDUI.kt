...
class DefaultSduiValidator : SduiValidator {
    ...
    private fun validateRadioButtonComponent(component: SduiComponent.RadioButtonComponent, errors: MutableList<String>) {
        val idPrefix = component.id?.let { "[$it] " } ?: ""
    ...
    private fun validateProgressBarComponent(component: SduiComponent.ProgressBarComponent, errors: MutableList<String>) {
        val idPrefix = component.id?.let { "[$it] " } ?: ""
    ...
    private fun validateSliderComponent(component: SduiComponent.SliderComponent, errors: MutableList<String>) {
        ...
        if (component.minValue >= component.maxValue) {
            ...
            errors.add("${idPrefix}Slider value must be between minValue and maxValue, got: value=${component.value}, min=${component.minValue}, max=${component.maxValue}")
        }
